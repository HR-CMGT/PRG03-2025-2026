function showDate() {
  ...
  // alternatief: datetimeformat gebruiken
  let options = {
    dateStyle: 'full',
    timeStyle: 'long',
...
console.log(daysUntilMyBirthday('2026-05-10')); //85

// taal formatting
const df = new Intl.RelativeTimeFormat('nl-NL', {style: 'long'});
console.log(df.format(daysUntilMyBirthday('2026-05-10'), 'days')); // "over X dagen"
